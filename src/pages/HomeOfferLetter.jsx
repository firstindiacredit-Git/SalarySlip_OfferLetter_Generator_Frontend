...
const HomeOfferLetter = () => {
  ...
  const fetchOfferLetter = async () => {
    try {
      ...
      const response = await fetch(`https://salary-slip-offer-letter-generator-frontend.vercel.app/api/offer-letter/${employeeInfo.employeeId}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const employeeInfo = JSON.parse(localStorage.getItem('employeeInfo'));
      const response = await fetch("https://salary-slip-offer-letter-generator-frontend.vercel.app/api/employees/apply-offer-letter", {
        method: "POST",
        headers: {
